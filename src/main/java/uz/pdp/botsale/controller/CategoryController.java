...
public class CategoryController {
    ...
    public HttpEntity<?> getExcel() {
        return excelService.getCategory();
    }

    @PreAuthorize("hasAnyRole('ROLE_ADMIN','ROLE_DIRECTOR')")
    @PutMapping("/{id}")
    public HttpEntity<?> getCategoryCol(@PathVariable Integer id) {
        ApiResponseModel responseModel = categoryService.getCategoryCol(id);
